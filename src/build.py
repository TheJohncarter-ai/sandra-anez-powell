...
COLLS = {
    ...
    'bay':     dict(name='Majesty of the Bay', gloss='', intro='Regattas, harbor moons and the creatures under the chop — the Chesapeake as Sandra sees it from Annapolis.', color='#2E5FA3'),
...
P = [
 ('s_regatta', 860, 822, 'bay', 'Regatta at Golden Hour', PRINTS, 'Acrylic painting: six sailboats race beneath a blazing gold sun, orange sky over pink and violet water'),
 ('s_violet', 860, 650, 'bay', 'Violet Fleet', PRINTS, 'Acrylic painting: purple-sailed boats scattered across speckled blue and yellow water'),
 ('s_fire', 649, 860, 'bay', 'Fire on the Water', PRINTS, 'Acrylic painting: sailboats with red, pink and orange sails on speckled blue water'),
 ('s_emerald', 818, 860, 'bay', 'Emerald Sails', PRINTS, 'Acrylic painting: green sails beneath swirling red, green and blue orbs in a yellow sky'),
 ('s_moonlight', 654, 860, 'bay', 'Moonlight Sail', PRINTS, 'Acrylic painting: a lone sailboat on deep blue water beneath a huge swirling yellow moon'),
 ('d10_0', 769, 377, 'bay', 'Majesty of the Bay No. 1', ASK, 'Acrylic painting: colorful waterfront cottages beside a blue bay under a golden full moon and red sky'),
 ('d10_2', 427, 325, 'bay', 'Majesty of the Bay No. 2', ASK, 'Acrylic painting: a line of white sails on turquoise water, reflections streaked with gold'),
 ('d11_1', 707, 274, 'bay', 'Majesty of the Bay No. 3', ASK, 'Acrylic painting: an orange-sailed and a gold-sailed boat cross a wide band of blue water'),
 ('d10_7', 589, 447, 'bay', 'Majesty of the Bay No. 4', ASK, 'Acrylic painting: three rowboats drawn together on choppy blue water'),
 ('d11_0', 741, 533, 'bay', 'Majesty of the Bay No. 5', ASK, 'Acrylic painting: a red-sailed boat off a wooded shore, white-capped waves rolling onto the beach'),
 ('d11_4', 651, 451, 'bay', 'Majesty of the Bay No. 6', ASK, 'Acrylic painting: a translucent jellyfish trailing flowered tendrils across a marigold ground'),
 ('d11_6', 451, 651, 'bay', 'Majesty of the Bay No. 7', ASK, 'Acrylic painting: pale jellyfish drifting through deep blue water lit from above'),
